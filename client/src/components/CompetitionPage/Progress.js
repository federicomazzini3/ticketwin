...
const Progress = ({ maxTicketNumber, ticketSoldNumber }) => {
    ...
    return (
        <Grid container item xs={12} sx={{ mt: 10, textAlign: 'center' }}>
            <Box tabIndex={0} sx={{ width: '100%', mr: 1 }}>
                <Typography align={'center'} aria-label={`${ticketSoldNumber} sold ticket of ${maxTicketNumber}`}>{ticketSoldNumber} ticket venduti</Typography>
            </Box>
